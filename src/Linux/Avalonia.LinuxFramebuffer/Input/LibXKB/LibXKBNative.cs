...
internal static unsafe class LibXKBNative
{
    ...
    {
        //"const char *
        [MarshalAs(UnmanagedType.LPStr)] public string rules;

        //const char *
        [MarshalAs(UnmanagedType.LPStr)] public string model;

        //const char *
        [MarshalAs(UnmanagedType.LPStr)] public string layout;

        //const char *
        [MarshalAs(UnmanagedType.LPStr)] public string variant;

        //const char *
        [MarshalAs(UnmanagedType.LPStr)] public string options;
    }
    ...
    [DllImport(LibXkb, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern xkb_keymap xkb_keymap_new_from_names(xkb_context context,[In] ref xkb_rule_names names,
    ...
    [DllImport(LibXkb, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern xkb_state_component xkb_state_update_key(xkb_state state, uint key,
    ...
    [DllImport(LibXkb, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern int xkb_keymap_key_get_syms_by_level(xkb_keymap keymap, uint key, uint layout, uint level,
        out IntPtr syms);
    ...
    [DllImport(LibXkb, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern int xkb_keysym_to_utf8(uint keysym, [MarshalAs(UnmanagedType.LPStr)] StringBuilder buffer,
        nuint size);

    [DllImport(LibXkb, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern int xkb_state_key_get_utf8(xkb_state state, uint key,
        [MarshalAs(UnmanagedType.LPStr)] StringBuilder buffer, nuint size);

    [DllImport(LibXkb, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern int xkb_context_include_path_append(xkb_context context, string path);

    [DllImport(LibXkb, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern void xkb_context_set_log_level(xkb_context context, xkb_log_level level);
    
    [DllImport(LibXkb, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public  static  extern  void xkb_context_set_log_verbosity(xkb_context context, int verbosity);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void xkb_log_fn(xkb_context context, xkb_log_level level,
